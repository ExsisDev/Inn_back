  ...
  return regeneratorRuntime.async(function createAlly$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 13:
          _context.next = 15;
          return regeneratorRuntime.awrap(createUserAndAlly(userAttributes, allyAttributes));
...
function createUserAndAlly(userAttributes, allyAttributes) {
